        ...
        <div>
            ...
            <section className="py-20 bg-blue-50/50 relative overflow-hidden">
                <div className="absolute inset-0 opacity-30">
                    ...
                    <div className="absolute bottom-10 right-10 w-40 h-40 bg-blue-200 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
                </div>

                <div className="container mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center bg-blue-100 text-blue-700 px-6 py-3 rounded-full text-sm font-semibold mb-6 border border-blue-200 shadow-sm">
                    ...
                    {loading ? (
                                        ...
                                        <div className="bg-white rounded-2xl border border-gray-100 hover:border-blue-300 hover:shadow-xl transition-all duration-500 overflow-hidden h-full flex flex-col group-hover:-translate-y-2 shadow-lg hover:shadow-blue-100">
                                            ...
                                            <div className="p-7 pb-5">
                                                <div className="flex items-center mb-5">
                                                    {job.companyImage ? (
                                                        ...
                                                        <div className="w-14 h-14 rounded-xl bg-blue-100 flex items-center justify-center mr-4 ring-2 ring-gray-100 group-hover:ring-blue-200 transition-all duration-300">
                                                ...
                                                {job.skills && job.skills.length > 0 && (
                                                    <div className="flex flex-wrap gap-2 mb-6">
                                                        {job.skills.slice(0, 3).map((skill, skillIndex) => (
                                                            <span
                                                                key={skillIndex}
                                                                className="px-3 py-1.5 bg-blue-50 text-blue-600 text-sm rounded-full font-medium border border-blue-100 hover:border-blue-200 transition-colors"
                                                            >
                                                                {skill}
                                                            </span>
                                                        ))}
                                            ...
                                            <div className="px-7 pb-7 mt-auto">
                                                <button
                                                    ...
                                                    className="w-full bg-blue-600 hover:bg-blue-700 hover:shadow-lg text-white font-semibold py-3.5 px-6 rounded-xl transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center group/btn"
                                                >
                        ...
                        <div className="text-center py-16 max-w-md mx-auto">
                            ...
                            <button
                                onClick={() => navigate('/jobs')}
                                className="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                            >
                                Browse All Jobs
                            </button>
                        </div>
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative">
                        <div className="hidden lg:block absolute top-1/2 left-1/3 w-1/3 h-0.5 bg-blue-300 transform -translate-y-1/2"></div>
                        <div className="hidden lg:block absolute top-1/2 right-1/3 w-1/3 h-0.5 bg-blue-300 transform -translate-y-1/2"></div>
                                ...
                                <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-4 relative overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center justify-between mb-6">
                                            ...
                                            <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="absolute inset-0 opacity-5">
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-600 rounded-full blur-3xl"></div>
                </div>

                <div className="container mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="bg-blue-50 border border-blue-100 rounded-3xl p-12 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                    Ready to start your
                                    <br />
                                    <span className="text-blue-600">remote career journey?</span>
                                </h2>
