...
const Hero = () => {
    ...
    return (
        <div className="min-h-screen bg-white relative overflow-hidden">
            ...
            {/* Main Content */}
            <div className="relative z-10 container mx-auto px-8 sm:px-16 lg:px-24 xl:px-32 pt-20 pb-10">
                <div className="text-center w-full mx-auto space-y-12 min-h-[calc(100vh-8rem)] flex flex-col justify-center">
                    {/* Hero Title */}
                    ...
                    <div className="w-[75%] mx-auto">
                        <div className="bg-white/80 backdrop-blur-sm border border-gray-400/50 rounded-2xl px-3 py-2 transition-all duration-300 bg-gradient-to-r from-white via-white to-gray-50">
                            <div className="flex items-center gap-0 w-full">
                                <div className="flex-1 relative">
                                    <input
                                        ...
                                        className="w-full pl-4 pr-4 py-3 text-lg border-0 rounded-l-2xl focus:outline-none bg-transparent"
                                    />
                                </div>

                                <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
